...
window.addEventListener("load", () => {
              ...
              <div class="flex flex-col gap-2 w-full">
                ...
                taskCard.checkboxStatus === true ? "strike" : ""
                  ...
                  <div class="info flex items-center gap-1 text-xs mt-2 ">
                      ...
                      <h1 class="min-w-fit info badge badge-soft ${taskCard.checkboxStatus === true ? "badge-success" : "badge-warning" } card-status">${taskCard.checkboxStatus === true ? "Status:Complete" : "Status:Pending"}</h1>
                  </div>
              </div>
  ...
  function saveTasks() {
    localStorage.setItem("storage-test", JSON.stringify(taskArray));
  }
  ...
  function checkTask(e) {
    ...
    let titleElem = taskCard.querySelector(".task-title");
    ...
    titleElem.classList.toggle("strike");
  ...
  function loadTasks() {
    const savedTasks = localStorage.getItem("storage-test");
    if (savedTasks) {
